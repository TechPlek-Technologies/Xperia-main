                    ...
                    <div className="mk-ver-menu-wrap">
                      <div className="menu-main-navigation-container">
                        <ul id="menu-main-navigation-1" className="mk-ver-menu">
                          <li className="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home current-menu-ancestor current-menu-parent menu-item-has-children menu-item-1965 swm-m-active">
                            <a
                              href="/"
                              aria-current="page"
                            >
                            ...
                            <ul className="sub-menu">
                              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-1255 current_page_item menu-item-1981 swm-m-active">
                                <a
                                  href="/"
                                  aria-current="page"
                                >
                              ...
                              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1971">
                                <a href="/creative-agency/">
                                  creative agency
                                </a>
                              </li>
                              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1972">
                                <a href="/digital-agency/">
                                  digital agency
                                </a>
                              </li>
                              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1986">
                                <a href="/portfolio-metro/">
                                  portfolio metro
                                </a>
                              </li>
                              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1976">
                                <a href="/fullscreen-slider/">
                                  fullscreen slider
                                </a>
                              </li>
                              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1980">
                                <a href="/interactive-projects/">
                                  interactive projects
                                </a>
                              </li>
                              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1978">
                                <a href="/horizontal-showcase/">
                                  horizontal showcase
                                </a>
                              </li>
                              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1979">
                                <a href="/interactive-links/">
                                  interactive links
                                </a>
                              </li>
                              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1992">
                                <a href="/thumbnail-slider/">
                                  thumbnail slider
                                </a>
                              </li>
                            </ul>
                          ...
                          <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1993">
                            ...
                            <ul className="sub-menu">
                              ...
                              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1973">
                                <a href="/faq-page/">
                                  faq page
                                </a>
                              </li>
                              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1987">
                                <a href="/pricing/">
                                  pricing
                                </a>
                              </li>
                          ...
                          <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1994">
                            <a href="#">
                              portfolio
                              <svg
                                className="swm-svg--angle swm-svg-submenu-indicator"
                            ...
                            <ul className="sub-menu">
                              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1990">
                                <a href="/standard-list/">
                                  standard list
                                </a>
                              </li>
                              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1982">
                                <a href="/masonry-list/">
                                  masonry list
                                </a>
                              </li>
                              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1977">
                                <a href="/gallery-list/">
                                  gallery list
                                </a>
                              </li>
                              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1985">
                                <a href="/portfolio-metro-2/">
                                  portfolio metro
                                </a>
                              </li>
                              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1984">
                                <a href="/portfolio-horizontal/">
                                  portfolio horizontal
                                </a>
                              </li>
                              <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1996">
                                <a href="#">
                                  layouts
                                  <svg
                                    className="swm-svg--angle swm-svg-submenu-indicator"
                                ...
                                <ul className="sub-menu">
                                  <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1991">
                                    <a href="/three-columns/">
                                      three columns
                                    </a>
                                  </li>
                                  <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1975">
                                    <a href="/four-columns/">
                                      four columns
                                    </a>
                                  </li>
                                  <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1974">
                                    <a href="/five-columns-wide/">
                                      five columns wide
                                    </a>
                                  </li>
                                  <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1989">
                                    <a href="/six-column-wide/">
                                      six columns wide
                                    </a>
                                  </li>
                                </ul>
                              </li>
                              <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1997">
                                <a href="#">
                                  portfolio single
                                  <svg
                                    className="swm-svg--angle swm-svg-submenu-indicator"
                                ...
                                <ul className="sub-menu">
                                  <li className="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-2170">
                                    <a href="/portfolio-item/casa-mondo-2/">
                                      custom layout
                                    </a>
                                  </li>
                                  <li className="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-2166">
                                    <a href="/portfolio-item/cloud-scape-2/">
                                      large images
                                    </a>
                                  </li>
                                  <li className="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-2162">
                                    <a href="/portfolio-item/nova-wade/">
                                      thumbnail slider
                                    </a>
                                  </li>
                                  <li className="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-2169">
                                    <a href="/portfolio-item/aqua-vista-2/">
                                      square images
                                    </a>
                                  </li>
                                  <li className="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-2167">
                                    <a href="/portfolio-item/ocean-mist-2/">
                                      carousel slider
                                    </a>
                                  </li>
                                  <li className="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-2161">
                                    <a href="/portfolio-item/urban-blend-2/">
                                      masonry large
                                    </a>
                                  </li>
                                  <li className="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-2163">
                                    <a href="/portfolio-item/bright-path-2/">
                                      masonry small
                                    </a>
                                  </li>
                                  <li className="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-2164">
                                    <a href="/portfolio-item/earth-bound-2/">
                                      small slider
                                    </a>
                                  </li>
                                  <li className="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-2168">
                                    <a href="/portfolio-item/galaxy-forge-2/">
                                      horizontal images
                                    </a>
                                  </li>
                                </ul>
                          ...
                          <li className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1995">
                            ...
                            <ul className="sub-menu">
                              ...
                              <li className="menu-item menu-item-type-post_type menu-item-object-post menu-item-2244">
                                <a href="/hushed-whispers-echo-through-ruins/">
                                  blog single
                                </a>
                              </li>
                            </ul>
              ...
              >
                <div className="elementor-widget-container">
                  <div className="mk-vertical-menu-container">
                    <div className="mk-ver-menu-wrap">
                      <div className="menu-main-navigation-container">
                        <ul id="menu-main-navigation-3" className="mk-ver-menu">
                          <li className="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home current-menu-ancestor current-menu-parent menu-item-has-children menu-item-1965 swm-m-active">
                            <a
                              href="/"
                              aria-current="page"
