            ...
            <div className="mk-carousel-slider-holder">
              ...
              >
                <div className="swiper-wrapper">
                  <div className="mk-swiper-item swiper-slide size-default">
                    ...
                    <div className="mk-carousel-slider-img-holder">
                      <div className="mk-carousel-slider-img">
                        <img
                          ...
                          alt=""
                          srcSet={`
                                  https://api.xperiagroup.in${JSON.parse(data.carousel1).url}          1400w,
                    ...
                    <div className="mk-carousel-slider-img-holder">
                      <div className="mk-carousel-slider-img">
                        <img
                          ...
                          alt=""
                          srcSet={`
                                  https://api.xperiagroup.in${JSON.parse(data.carousel2).url}          1400w,
                    ...
                    <div className="mk-carousel-slider-img-holder">
                      <div className="mk-carousel-slider-img">
                        <img
                          ...
                          alt=""
                          srcSet={`
                                  https://api.xperiagroup.in${JSON.parse(data.carousel3).url}          1400w,
